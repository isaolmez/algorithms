 ...
 *  <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 */
public class SeparateChainingHashSTBook<Key, Value> {
     ...
     */
    public SeparateChainingHashSTBook() {
        this(INIT_CAPACITY);
    } 
     ...
     */
    public SeparateChainingHashSTBook(int M) {
        this.M = M;
    ...
    private void resize(int chains) {
        SeparateChainingHashSTBook<Key, Value> temp = new SeparateChainingHashSTBook<Key, Value>(chains);
        for (int i = 0; i < M; i++) {
    ...
    public static void main(String[] args) { 
        SeparateChainingHashSTBook<String, Integer> st = new SeparateChainingHashSTBook<String, Integer>();
