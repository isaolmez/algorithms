 ...
 *  <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 */
public class LinearProbingHashSTBook<Key, Value> {
     ...
     */
    public LinearProbingHashSTBook() {
        this(INIT_CAPACITY);
    }
     ...
     */
    public LinearProbingHashSTBook(int capacity) {
        M = capacity;
    ...
    private void resize(int capacity) {
        LinearProbingHashSTBook<Key, Value> temp = new LinearProbingHashSTBook<Key, Value>(capacity);
        for (int i = 0; i < M; i++) {
            if (keys[i] != null) {
    ...
    public static void main(String[] args) { 
        LinearProbingHashSTBook<String, Integer> st = new LinearProbingHashSTBook<String, Integer>();
