...
public class Interval2D {
    ...
    public static void main(String[] args) {
        double xlo = 0.1;//Double.parseDouble(args[0]);
        double xhi = 0.9;//Double.parseDouble(args[1]);
        double ylo = 0.1;//Double.parseDouble(args[2]);
        double yhi = 0.9;//Double.parseDouble(args[3]);
        int T = 10000;//Integer.parseInt(args[4]);
